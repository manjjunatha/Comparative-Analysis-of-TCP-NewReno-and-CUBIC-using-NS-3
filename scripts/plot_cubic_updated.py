...
# =========================
cwnd_file = "cwnd_cubic_updated.dat"
rtt_file = "rtt_cubic_updated.dat"
flow_file = "flow_metrics_per_sec_cubic_updated.dat"
...
# ✅ Aggregate flows (IMPORTANT if >1 flow)
...
# 3. Title and Label
# =========================
fig.suptitle("TCP Performance Analysis",
