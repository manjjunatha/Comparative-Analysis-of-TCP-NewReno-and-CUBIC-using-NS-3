...
# =========================
USE_CUBIC = True   # True → CUBIC, False → Reno

if USE_CUBIC:
    cwnd_file = "cwnd_cubic.dat"
    rtt_file = "rtt_cubic.dat"
    flow_file = "flow_metrics_per_sec_cubic.dat"
else:
    cwnd_file = "cwnd_node0_tcp.dat"
    rtt_file = "tcp_rtt.dat"
    flow_file = "flow_metrics_per_sec.dat"
...
# ✅ If multiple flows exist → take sum throughput & loss
